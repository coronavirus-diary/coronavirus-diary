...
abstract class AppLocalizations {
  ...
  // Heading on the initial screen. The name of the app, Covid Near Me, should not be translated
  ...
  // Heading that's shown after the user has agreed to the app license. The name of the app, Covid Near Me, should not be translated
