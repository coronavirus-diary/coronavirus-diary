...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get symptomReportIntroStepHealthQuestions => '回答与您的健康状况有关的几个简单的问题，即可开始跟踪您的症状。';
...
如果您同意以上所有条件，并已年满 18 周岁，请点击“我同意”。否则，请点击“我不同意”。''';
  ...
  @override
  String get shareAppDownloadPrompt => '下载 CovidNearMe 以获取本地 COVID-19 信息和统计信息。匿名提供您的症状信息，为您的社区尽一份力！{{ APP_LINK }}';
  ...
  @override
  String get safetyTipsSocialDistancing => '注意保持社交距离，也就是说限制与他人的接触。出门在外时，请与他人保持至少 6 英尺的距离。';
